...
const BanaApi = {
    ...
    get: function (ajax_post_type = 'test', username = {}) {
        return fetch(
...
const main = {
    ...
    load_twitch_chat: function (twitch_channel_name) {
        ...
        //     var userInfo = userInfoMap.get(username)
        ...
        //         }, (err, res, body) => {
        //             if (body._total >= 1) {
        //                 userInfoMap.set(username, body.users[0])
        //                 if (!obs_mode) {
        //                     this.writeToScreen(`<img class="circleImg" src="${body.users[0].logo}"> <span style="color:#9147ff">${body.users[0].display_name}</span>: 进入了直播间`);
        //                 }
        //             }
        //         });
        //     }else{
        //         if (!obs_mode) {
        //             this.writeToScreen(`<img class="circleImg" src="${userInfo.logo}"> <span style="color:#9147ff">${userInfo.display_name}</span>: 进入了直播间`);
        //         }
        //     }
        ...
        //                 userInfoMap.set(username, body.users[0])
        //                 if (!obs_mode) {
        //                     this.writeToScreen(`<span style="color:#9147ff">${body.users[0].display_name}</span>: 离开了直播间`);
        //                 }
        //             }
        //         });
        //     }else{
        //         if (!obs_mode) {
        //             this.writeToScreen(`<span style="color:#9147ff">${userInfo.display_name}</span>: 离开了直播间`);
        //         }
        //     }
        // });
